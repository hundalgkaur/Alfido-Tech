...
abs_value = Button(tk_calc, button_params, text='abs',bg="orange",
                   command=lambda: button_click('abs(')).grid(row=1, column=0, sticky="nsew")
# Remainder of a division
modulo = Button(tk_calc, button_params, text='mod',bg="orange",
                command=lambda: button_click('%')).grid(row=1, column=1, sticky="nsew")
# Integer division quotient
int_div = Button(tk_calc, button_params, text='div',bg="orange",
                 command=lambda: button_click('//')).grid(row=1, column=2, sticky="nsew")
# Factorial of a number
factorial_button = Button(tk_calc, button_params, text='x!',bg="orange",
                          command=fact_func).grid(row=1, column=3, sticky="nsew")
# Euler's number e
eulers_num = Button(tk_calc, button_params, text='e',bg="orange",
                    command=lambda: button_click(str(math.exp(1)))).grid(row=1, column=4, sticky="nsew")

# --2nd row--
# Sine of an angle in degrees
sine = Button(tk_calc, button_params, text='sin',bg="orange",
...
# Pi(3.14...) number
pi_num = Button(tk_calc, button_params, text='π',bg="orange",
                command=lambda: button_click(str(math.pi))).grid(row=2, column=4, sticky="nsew")

# --3rd row--
# Power of 2
second_power = Button(tk_calc, button_params, text='x\u00B2',bg="orange",
...
# Powers of 10
tens_powers = Button(tk_calc, button_params, text='10^x',bg="orange", font=('sans-serif', 15, 'bold'),
                     command=lambda: button_click('10**')).grid(row=3, column=4, sticky="nsew")

# --4th row--
# Square root of a number
square_root = Button(tk_calc, button_params, text='\u00B2\u221A',bg="orange",
...
log_basee = Button(tk_calc, button_params, text='ln',bg="orange",
                   command=lambda: button_click('ln(')).grid(row=4, column=4, sticky="nsew")

# --5th row--
# Add a left parentheses
left_par = Button(tk_calc, button_params, text='(',bg="orange",
...
ex = Button(tk_calc, button_params, text='e^x',bg="orange",
            command=lambda: button_click('e(')).grid(row=5, column=4, sticky="nsew")

# --6th row--
button_7 = Button(tk_calc, button_params_main, text='7',bg="orange",
                  command=lambda: button_click('7')).grid(row=6, column=0, sticky="nsew")
button_8 = Button(tk_calc, button_params_main, text='8',bg="orange",
                  command=lambda: button_click('8')).grid(row=6, column=1, sticky="nsew")
button_9 = Button(tk_calc, button_params_main, text='9',bg="orange",
...
delete_all = Button(tk_calc, bd=0, fg='#000', font=('sans-serif', 20, 'bold'),
                    text='AC', command=button_clear_all, bg='red').grid(row=6, column=4, sticky="nsew")

# --7th row--
button_4 = Button(tk_calc, button_params_main, text='4',bg="orange",
                  command=lambda: button_click('4')).grid(row=7, column=0, sticky="nsew")
button_5 = Button(tk_calc, button_params_main, text='5',bg="orange",
                  command=lambda: button_click('5')).grid(row=7, column=1, sticky="nsew")
button_6 = Button(tk_calc, button_params_main, text='6',bg="orange",
...
# --8th row--
button_1 = Button(tk_calc, button_params_main, text='1',bg="orange",
                  command=lambda: button_click('1')).grid(row=8, column=0, sticky="nsew")
button_2 = Button(tk_calc, button_params_main, text='2',bg="orange",
                  command=lambda: button_click('2')).grid(row=8, column=1, sticky="nsew")
button_3 = Button(tk_calc, button_params_main, text='3',bg="orange",
...
# --9th row--
button_0 = Button(tk_calc, button_params_main, text='0',bg="orange",
                  command=lambda: button_click('0')).grid(row=9, column=0, sticky="nsew")
point = Button(tk_calc, button_params_main, text='.',bg="orange",
               command=lambda: button_click('.')).grid(row=9, column=1, sticky="nsew")
exp = Button(tk_calc, button_params_main, text='EXP', bg="orange",font=('sans-serif', 16, 'bold'),
             command=lambda: button_click(E)).grid(row=9, column=2, sticky="nsew")
equal = Button(tk_calc, button_params_main, text='=',bg="green",
